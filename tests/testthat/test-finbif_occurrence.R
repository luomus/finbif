...
test_that("fetching occurrences with async works", {
  ...
  vcr::use_cassette("finbif_occurrence_async", {

    fg <- finbif::finbif_occurrence(quiet = TRUE)
  ...
  expect_snapshot(list(fg, bg[["get_result"]]()))

  expect_equal(fg, bg[["get_result"]](), ignore_attr = "time")
