...
#' \describe{
#'   \item{`finbif_api_url`}{Character. The base URL of the API to query.
#'     Default: `"https://api.laji.fi"`}
...
#'     Default: `FALSE`}
#'   \item{`finbif_use_async`}{Logical. Should downloading and processing of
#'     data be done asynchronously? Default: `TRUE`}
...
#'     `TRUE`}
#'   \item{`finbif_use_cache_metadata`}{Logical or Integer. If `TRUE` or a
#'     number greater than zero, then metadata-caching will be used. If not
#'     logical then cache will be invalidated after the number of hours
#'     indicated by the value. Default: `TRUE`}
...
#'   \item{`finbif_locale`}{Character. One of the supported two-letter
#'     ISO 639-1 language codes. Current supported languages are English,
#'     Finnish and Swedish. By default, the system settings are used to set this
#'     option if they are set to one of the supported languages, otherwise
#'     English is used.}
