...
[![Build Status](https://github.com/luomus/finbif/actions/workflows/check-standard.yml/badge.svg?branch=main)](https://github.com/luomus/finbif/actions)
...
To cite the finbif R package in publications please use:
  ...
  Morris, William K. (2026). Introduction to the finbif package. R
  package version 0.9.12, https://doi.org/10.5281/zenodo.3612814
